...
ffuf -u $1/FUZZ -w ./wordlist/fuzz-dir-cve.txt -H "User-Agent: Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; MSBrowserIE; rv:11.0) like Gecko" -H "X-Forwarded-For: 127.0.0.1" -fc 400,401,403,404 -of csv -or true -t 1 -o $domain_name.fuzz-dir-cve.csv
...
ffuf -u $1/FUZZ -w ./wordlist/fuzz-dir-leaky-misconfigs.txt -H "User-Agent: Mozilla/5.0 (Windows NT 5.1; rv:38.0) Gecko/20100101 Firefox/38.0" -H "X-Forwarded-For: 127.0.0.1" -fc 400,401,403,404 -of csv -or true -t 1 -o $domain_name.fuzz-dir-leaky-misconfigs.csv
...
ffuf -u $1/FUZZ -w ./wordlist/fuzz-dir-backup_files.txt -H "User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:39.0) Gecko/20100101 Firefox/39.0" -H "X-Forwarded-For: 127.0.0.1" -fc 400,401,403,404 -of csv -or true -t 1 -o $domain_name.fuzz-dir-backup_files.txt
...
ffuf -u $1/FUZZ -w ./wordlist/fuzz-dir-api-info.txt -H "User-Agent: Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 5.1; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; .NET4.0C; .NET4.0E)" -H "X-Forwarded-For: 127.0.0.1" -fc 400,401,403,404 -of csv -t 1 -o $domain_name.fuzz-dir-api-info.csv
...
ffuf -u $1/FUZZ -w ./wordlist/fuzz-cgi-files.txt -H "User-Agent: Mozilla/5.0 (Windows NT 6.1; Win64; x64; Trident/7.0; rv:11.0) like Gecko" -H "X-Forwarded-For: 127.0.0.1" -fc 400,401,403,404 -of csv -or true -t 1 -o $domain_name.fuzz-dir-cgi-files.csv
...
#cat $domain_name-fuzz-dir.csv | grep -i -E 'http' | awk '{print $1}'
